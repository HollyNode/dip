...
const cantos = [
  { name: 'CANTO 1', link: '/canto1', imgSrc: '/Folder.png', previewSrc: '/images/canto1-bg.png' },
  { name: 'CANTO 2', link: '/canto2', imgSrc: '/Folder.png', previewSrc: '/images/canto2-bg.png' },
  { name: 'CANTO 3', link: '/canto3', imgSrc: '/Folder.png', previewSrc: '/images/canto3-bg.png' },
  { name: 'CANTO 4', link: '/canto4', imgSrc: '/Folder.png', previewSrc: '/images/canto4-bg.png' },
  // ... Add other cantos
];
